        ...
        if yes=="yes":
            def get_urls(tag, n, language):
                for url in search(tag, stop=n, lang=language):
                    return url
            strng="recipe of " +food
            recipe=get_urls(strng,1,'en')





    return render_template("index.html",imageis=x,content=content,protein=fatvar,food=food,link=recipe,prd=yes)
